...
def generate_enterprise_sap_data():
    ...
    # 1050 // 143 = 7 Belege pro Kreditor (Rest 49 erhalten 8 Belege)
    ...
    for v in all_vendors_list:
        ...
        # Erzeuge n_pos-1 zufällige Trennpunkte auf der Skala von 0 bis target_sum
    ...
    # Belege zeitlich durcheinanderwürfeln für maximale Realitätsnähe
...
with tab1:
    ...
    # Die hochperformante Echtzeit-Suchleiste
...
with tab2:
    ...
    # UI Placeholders für asynchrone / gethreadete Updates
    badge_container = st.empty()
    terminal_container = st.empty()
    
    # Initiale Platzhalter-Ansicht
...
with tab3:
    ...
    with col_msft:
        # EPIC 1.3: THE AUDITOR PROOF (The Microsoft Trap)
        st.markdown("""
        <div class="frosted-glass">
